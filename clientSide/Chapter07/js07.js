...
{
      //retrieve the information about the selected file
      ...
      try 
      {
            ...
            fr.onload = function() 
            {
                  ...
                  //store the text of the document, removing all html tags
      ...
      function wordCloud(sourceText)
      {
            ...
            //Remove stope words from the text
            ...
            //sort the words array in alphabetic order
            words.sort();
            ...
            //Get the value of the highest duplicate word
